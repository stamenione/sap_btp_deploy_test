		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#b2cadminuiui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"b2cadminuiui5-display": {
								"semanticObject": "b2cadminuiui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=b2cadminui.ui5",
									"url": sap.ui.require.toUrl("b2cadminui/ui5")
								}
							}
						}
					}
